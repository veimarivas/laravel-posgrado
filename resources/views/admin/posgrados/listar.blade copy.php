                                ...
                                <div class="row mb-4">
                                    <div class="col-12">
                                        <div class="d-flex justify-content-between align-items-center mb-2">
                                            <h6 class="mb-0"><i class="ri-money-dollar-circle-line me-1"></i> Planes de
                                                Pago</h6>
                                        </div>
                                        <div id="planes-pago-container">
                                            <!-- Aquí se generarán dinámicamente los planes y sus conceptos -->
                                        </div>
                                    </div>
                                </div>
