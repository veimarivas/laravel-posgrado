        ...
        <div class="row mb-3">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-light rounded-3 p-3">
                    <div>
                        <h4 class="mb-1 fw-bold text-dark">Gestión de Fases</h4>
                        <p class="text-muted mb-0">Administra las fases disponibles</p>
                    </div>
                    ...
                    @if (Auth::guard('web')->user()->can('fases.registrar'))
                        <div class="page-title-right">
                            <button type="button" class="btn btn-primary btn-lg waves-effect waves-light"
                                ...
                                <i class="ri-add-line align-bottom me-1"></i> Nueva Fase
                            </button>
                        </div>
                    @endif
                </div>
                        ...
                        <div class="d-flex align-items-center">
                            <div class="flex-shrink-0">
                                <div class="avatar-sm rounded-circle bg-primary bg-opacity-10">
                                    <i class="ri-list-check fs-24 text-primary"></i>
                                </div>
                            </div>
                            <div class="flex-grow-1 ms-3">
                                <p class="text-muted mb-1">Total Fases</p>
                                <h4 class="mb-0" id="totalFasesCounter">{{ $fases->total() }}</h4>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="flex-grow-1">
                                <div class="search-box position-relative">
                                    <input type="text" id="searchInput" class="form-control search form-control-lg ps-5"
                                        placeholder="Buscar fase por nombre..." value="{{ request('search') ?? '' }}">
                                    <i
            ...
            <div class="col-12">
                <div class="card border border-light shadow-sm">
                    <div class="card-header border-bottom-dashed d-flex align-items-center justify-content-between">
                        <h5 class="card-title mb-0 fw-bold">Listado de Fases</h5>
                        <div class="dropdown">
            ...
            <div class="modal-content border-0 shadow-lg">
                <div class="modal-header bg-primary-subtle p-3 position-relative">
                    <h5 class="modal-title fw-bold text-primary" id="registrarLabel">
                        <i class="ri-add-line me-2 align-bottom"></i>Registrar Nueva Fase
                    </h5>
                ...
                <form id="addForm" class="needs-validation" novalidate>
                    ...
                    <div class="modal-body p-4">
                        <div class="row g-3">
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    <label for="nombre_registro" class="form-label fw-medium">Nombre de la Fase <span
                                            class="text-danger">*</span></label>
                                    <input type="text" id="nombre_registro" name="nombre"
                                        class="form-control form-control-lg" placeholder="Ej: Fase 1, Fase de Inscripción"
                                        required>
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    <label for="color_registro" class="form-label fw-medium">Color <span
                                            class="text-danger">*</span></label>
                                    <div class="input-group">
                                        <input type="color" id="color_registro" name="color"
                                            class="form-control form-control-color" value="#007bff"
                                            title="Elige un color">
                                        <input type="text" id="color_text_registro"
                                            class="form-control form-control-lg" placeholder="#007bff" readonly>
                                    </div>
                                    <div class="invalid-feedback">Por favor selecciona un color</div>
                                    <div class="mt-2">
                                        <span>Vista previa: </span>
                                        <span id="preview_registro"
                                            style="display: inline-block; width: 30px; height: 30px; border: 1px solid #ccc; border-radius: 4px;"></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="modal-footer bg-light p-3">
                        ...
                        <button type="submit" class="btn btn-primary btn-lg addBtn" disabled>
                            ...
                            <span class="submit-text">Registrar Fase</span>
                        </button>
                    </div>
                </form>
            </div>
            ...
            <div class="modal-content border-0 shadow-lg">
                <div class="modal-header bg-warning-subtle p-3 position-relative">
                    <h5 class="modal-title fw-bold text-warning" id="modalModificarLabel">
                        <i class="ri-edit-line me-2 align-bottom"></i>Editar Fase
                    </h5>
                ...
                <form id="updateForm" class="needs-validation" novalidate>
                    ...
                    <div class="modal-body p-4">
                        <div class="row g-3">
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    <label for="nombre_edicion" class="form-label fw-medium">Nombre de la Fase <span
                                            class="text-danger">*</span></label>
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    <label for="color_edicion" class="form-label fw-medium">Color <span
                                            class="text-danger">*</span></label>
                                    <div class="input-group">
                                        <input type="color" id="color_edicion" name="color"
                                            class="form-control form-control-color" title="Elige un color">
                                        <input type="text" id="color_text_edicion"
                                            class="form-control form-control-lg" readonly>
                                    </div>
                                    <div class="invalid-feedback">Por favor selecciona un color</div>
                                    <div class="mt-2">
                                        <span>Vista previa: </span>
                                        <span id="preview_edicion"
                                            style="display: inline-block; width: 30px; height: 30px; border: 1px solid #ccc; border-radius: 4px;"></span>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="modal-footer bg-light p-3">
                        ...
                        <button type="submit" class="btn btn-warning btn-lg updateBtn" disabled>
                            ...
                            <span class="submit-text">Actualizar Fase</span>
                        </button>
                    </div>
                </form>
            </div>
            ...
            <div class="modal-content border-0 shadow-lg">
                ...
                <form id="deleteForm">
                    ...
                    <div class="modal-body p-4 text-center">
                        ...
                        <h4 class="mb-3 fw-bold">¿Estás seguro de eliminar esta fase?</h4>
                        <p class="text-muted mb-0">Esta acción no se puede deshacer. Si hay ofertas académicas asociadas a
                            esta
                            fase, deberás actualizarlas manualmente.</p>
        ...
        $(document).ready(function() {
            ...
            $('#registrar, #modalModificar, #modalEliminar').on('hidden.bs.modal', function() {
                if (this.id === 'registrar') {
                    ...
                    // Reset color input and preview
                    $('#color_registro').val('#007bff');
                    $('#color_text_registro').val('#007bff');
                    $('#preview_registro').css('background-color', '#007bff');
            ...
            // Sincronizar color input con text input y preview para registro
            ...
            // Sincronizar color input con text input y preview para edición
            ...
            $('#addForm').submit(function(e) {
                ...
                $.ajax({
                    ...
                    error: function(xhr) {
                        let errorMsg = 'Error al registrar la fase. Intenta nuevamente.';
                        if (xhr.responseJSON?.errors?.nombre) {
                            errorMsg = xhr.responseJSON.errors.nombre[0];
                        } else if (xhr.responseJSON?.errors?.color) {
                            errorMsg = xhr.responseJSON.errors.color[0];
            ...
            $('#updateForm').submit(function(e) {
                ...
                $.ajax({
                    ...
                    error: function(xhr) {
                        let errorMsg = 'Error al actualizar la fase. Intenta nuevamente.';
                        if (xhr.responseJSON?.errors?.nombre) {
                            errorMsg = xhr.responseJSON.errors.nombre[0];
                        } else if (xhr.responseJSON?.errors?.color) {
                            errorMsg = xhr.responseJSON.errors.color[0];
            ...
            $('#deleteForm').submit(function(e) {
                ...
                $.ajax({
                    ...
                    error: function(xhr) {
                        let errorMsg = 'Error al eliminar la fase. Intenta nuevamente.';
