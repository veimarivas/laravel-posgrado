        ...
        <div class="row mb-3">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-light rounded-3 p-3">
                    <div>
                        <h4 class="mb-1 fw-bold text-dark">Gestión de Conceptos de Pago</h4>
                        <p class="text-muted mb-0">Administra los conceptos de pago disponibles</p>
                    </div>
                    ...
                    @if (Auth::guard('web')->user()->can('conceptos.pagos.registrar'))
                        <div class="page-title-right">
                            <button type="button" class="btn btn-primary btn-lg waves-effect waves-light"
                                ...
                                <i class="ri-add-line align-bottom me-1"></i> Nuevo Concepto
                            </button>
                        </div>
                    @endif
                </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-grow-1 ms-3">
                                <p class="text-muted mb-1">Total Conceptos</p>
                                <h4 class="mb-0" id="totalConceptosCounter">{{ $conceptos->total() }}</h4>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="flex-grow-1">
                                <div class="search-box position-relative">
                                    <input type="text" id="searchInput" class="form-control search form-control-lg ps-5"
                                        placeholder="Buscar concepto de pago..." value="{{ request('search') ?? '' }}">
                                    <i
            ...
            <div class="col-12">
                <div class="card border border-light shadow-sm">
                    <div class="card-header border-bottom-dashed d-flex align-items-center justify-content-between">
                        <h5 class="card-title mb-0 fw-bold">Listado de Conceptos de Pago</h5>
                        <div class="dropdown">
                            ...
                            <table class="table table-borderless table-centered align-middle table-nowrap mb-0">
                                <thead class="table-light text-muted fw-semibold">
                                    <tr>
                                        ...
                                        <th class="px-3 py-3">Nombre del Concepto</th>
            ...
            <div class="modal-content border-0 shadow-lg">
                <div class="modal-header bg-primary-subtle p-3 position-relative">
                    <h5 class="modal-title fw-bold text-primary" id="registrarLabel">
                        <i class="ri-add-line me-2 align-bottom"></i>Registrar Nuevo Concepto
                    </h5>
                ...
                <form id="addForm" class="needs-validation" novalidate>
                    ...
                    <div class="modal-body p-4">
                        <div class="row g-3">
                            <div class="col-lg-12">
                                <div class="mb-3">
                                    <label for="nombre_registro" class="form-label fw-medium">Nombre del Concepto <span
                                            class="text-danger">*</span></label>
                                    <input type="text" id="nombre_registro" name="nombre"
                                        class="form-control form-control-lg"
                                        placeholder="Ej: Matrícula, Mensualidad, Materiales" required>
                    ...
                    <div class="modal-footer bg-light p-3">
                        ...
                        <button type="submit" class="btn btn-primary btn-lg addBtn" disabled>
                            ...
                            <span class="submit-text">Registrar Concepto</span>
                        </button>
                    </div>
                </form>
            </div>
            ...
            <div class="modal-content border-0 shadow-lg">
                <div class="modal-header bg-warning-subtle p-3 position-relative">
                    <h5 class="modal-title fw-bold text-warning" id="modalModificarLabel">
                        <i class="ri-edit-line me-2 align-bottom"></i>Editar Concepto de Pago
                    </h5>
                ...
                <form id="updateForm" class="needs-validation" novalidate>
                    ...
                    <div class="modal-body p-4">
                        <div class="row g-3">
                            <div class="col-lg-12">
                                <div class="mb-3">
                                    <label for="nombre_edicion" class="form-label fw-medium">Nombre del Concepto <span
                                            class="text-danger">*</span></label>
                    ...
                    <div class="modal-footer bg-light p-3">
                        ...
                        <button type="submit" class="btn btn-warning btn-lg updateBtn" disabled>
                            ...
                            <span class="submit-text">Actualizar Concepto</span>
                        </button>
                    </div>
                </form>
            </div>
            ...
            <div class="modal-content border-0 shadow-lg">
                ...
                <form id="deleteForm">
                    ...
                    <div class="modal-body p-4 text-center">
                        ...
                        <h4 class="mb-3 fw-bold">¿Estás seguro de eliminar este concepto?</h4>
                        <p class="text-muted mb-0">Esta acción no se puede deshacer. Si hay registros asociados a este
                            concepto, deberás actualizarlos manualmente.</p>
                        ...
                        success: function(res) {
                            if (res.exists) {
                                feedback.addClass('text-danger').html(
                                    '<i class="ri-error-warning-line me-1"></i> Este concepto ya existe'
                                );
                                submitBtn.prop('disabled', true);
                                input.addClass('is-invalid').removeClass('is-valid');
                            } else {
