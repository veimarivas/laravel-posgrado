        ...
        <div class="row mb-3">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-light rounded-3 p-3">
                    <div>
                        <h4 class="mb-1 fw-bold text-dark">Gestión de Áreas</h4>
                        <p class="text-muted mb-0">Administra las áreas disponibles</p>
                    </div>
                    ...
                    @if (Auth::guard('web')->user()->can('areas.registrar'))
                        <div class="page-title-right">
                            <button type="button" class="btn btn-primary btn-lg waves-effect waves-light"
                                ...
                                <i class="ri-add-line align-bottom me-1"></i> Nueva Área
                            </button>
                        </div>
                    @endif
                </div>
                        ...
                        <div class="d-flex align-items-center">
                            <div class="flex-shrink-0">
                                <div class="avatar-sm rounded-circle bg-primary bg-opacity-10">
                                    <i class="ri-folder-2-line fs-24 text-primary"></i>
                                </div>
                            </div>
                            <div class="flex-grow-1 ms-3">
                                <p class="text-muted mb-1">Total Áreas</p>
                                <h4 class="mb-0" id="totalAreasCounter">{{ $areas->total() }}</h4>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="flex-grow-1">
                                <div class="search-box position-relative">
                                    <input type="text" id="searchInput" class="form-control search form-control-lg ps-5"
                                        placeholder="Buscar área..." value="{{ request('search') ?? '' }}">
                                    <i
            ...
            <div class="col-12">
                <div class="card border border-light shadow-sm">
                    <div class="card-header border-bottom-dashed d-flex align-items-center justify-content-between">
                        <h5 class="card-title mb-0 fw-bold">Listado de Áreas</h5>
                        <div class="dropdown">
                            ...
                            <table class="table table-borderless table-centered align-middle table-nowrap mb-0">
                                <thead class="table-light text-muted fw-semibold">
                                    <tr>
                                        ...
                                        <th class="px-3 py-3">Nombre del Área</th>
            ...
            <div class="modal-content border-0 shadow-lg">
                <div class="modal-header bg-primary-subtle p-3 position-relative">
                    <h5 class="modal-title fw-bold text-primary" id="registrarLabel">
                        <i class="ri-add-line me-2 align-bottom"></i>Registrar Nueva Área
                    </h5>
                ...
                <form id="addForm" class="needs-validation" novalidate>
                    ...
                    <div class="modal-body p-4">
                        <div class="row g-3">
                            <div class="col-lg-12">
                                <div class="mb-3">
                                    <label for="nombre_registro" class="form-label fw-medium">Nombre del Área <span
                    ...
                    <div class="modal-footer bg-light p-3">
                        ...
                        <button type="submit" class="btn btn-primary btn-lg addBtn" disabled>
                            ...
                            <span class="submit-text">Registrar Área</span>
                        </button>
                    </div>
                </form>
            </div>
            ...
            <div class="modal-content border-0 shadow-lg">
                <div class="modal-header bg-warning-subtle p-3 position-relative">
                    <h5 class="modal-title fw-bold text-warning" id="modalModificarLabel">
                        <i class="ri-edit-line me-2 align-bottom"></i>Editar Área
                    </h5>
                ...
                <form id="updateForm" class="needs-validation" novalidate>
                    ...
                    <div class="modal-body p-4">
                        <div class="row g-3">
                            <div class="col-lg-12">
                                <div class="mb-3">
                                    <label for="nombre_edicion" class="form-label fw-medium">Nombre del Área <span
                                            class="text-danger">*</span></label>
                    ...
                    <div class="modal-footer bg-light p-3">
                        ...
                        <button type="submit" class="btn btn-warning btn-lg updateBtn" disabled>
                            ...
                            <span class="submit-text">Actualizar Área</span>
                        </button>
                    </div>
                </form>
            </div>
            ...
            <div class="modal-content border-0 shadow-lg">
                ...
                <form id="deleteForm">
                    ...
                    <div class="modal-body p-4 text-center">
                        ...
                        <h4 class="mb-3 fw-bold">¿Estás seguro de eliminar esta área?</h4>
                        <p class="text-muted mb-0">Esta acción no se puede deshacer. Si hay registros asociados a esta
                            área, deberás actualizarlos manualmente.</p>
